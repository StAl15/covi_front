    ...
    return (<div className="content" >
        <div style={
            ...
            <div className="left_side" >
                ...
                <div className="list_symptoms"
                    style={
                        { marginTop: '70px', marginLeft: '30px' }} >
                    <h4 style={
                        { marginLeft: '5px', marginBottom: '20px', fontFamily: 'Roboto-Medium' }} > Симптомы </h4> <CustomCheckbox param="Кашель"
                            status={cold}
                            onChange={setCold} /> <CustomCheckbox param="Лихорадка" />
                ...
                { display: 'flex', width: '-webkit-fill-available', alignItems: 'right', marginTop: 'auto' }} >
                <div style={
